          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              {copy.models.map(([name, current, desc]) => (
                <div key={name} className="flex items-center justify-between p-6 rounded-3xl border border-slate-800/60 bg-black/40 backdrop-blur-xl">
                  <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button className="text-xs font-bold text-slate-400 hover:text-white transition-colors">{copy.change}</button>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              {copy.securityItems.map(([name, desc], index) => {
                ...
                return (
                  <div key={name} className="group flex items-center justify-between p-6 rounded-3xl border border-slate-800/60 bg-black/40 backdrop-blur-xl hover:border-blue-500/30 transition-all cursor-pointer">
